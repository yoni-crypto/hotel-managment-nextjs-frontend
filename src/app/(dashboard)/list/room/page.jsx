  ...
  return (
    <div className='w-full h-full bg-[#f3f3f3] p-4 py-6'>
      <div className=' flex flex-row items-center justify-between '>
        <h1 className='hidden md:block text-xl font-semibold'>Rooms</h1>
        <div className='ml-auto flex flex-row items-center gap-4'>
          <div className='flex flex-row items-center justify-center gap-2 bg-white px-2 rounded-3xl'>
            ...
            <input type='text' placeholder='Search Rooms,Types etc' className='bg-transparent outline-none p-2 text-gray-500 text-sm' />
          </div>
